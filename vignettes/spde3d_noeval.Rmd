---
title: "SPDE models on 3D meshes (no evaluation)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{SPDE models on 3D meshes (no evaluation)}
...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  eval = FALSE # In order to have a vignette showing the code but not evaluating it
)
```
...
```{r fig.alt="Spatial covariance function. A solid curve shows the theoretical covariance. Points show the numerical approximation covariance."}
